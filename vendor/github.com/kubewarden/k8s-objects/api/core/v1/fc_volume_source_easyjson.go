...
func easyjson31c58ca6DecodeGithubComKubewardenK8sObjectsApiCoreV1(in *jlexer.Lexer, out *FCVolumeSource) {
...
func easyjson31c58ca6EncodeGithubComKubewardenK8sObjectsApiCoreV1(out *jwriter.Writer, in FCVolumeSource) {
	out.RawByte('{')
	first := true
	_ = first
	if in.FSType != "" {
...
func (v FCVolumeSource) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson31c58ca6EncodeGithubComKubewardenK8sObjectsApiCoreV1(&w, v)
...
func (v *FCVolumeSource) UnmarshalJSON(data []byte) error {
	...
	easyjson31c58ca6DecodeGithubComKubewardenK8sObjectsApiCoreV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *FCVolumeSource) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson31c58ca6DecodeGithubComKubewardenK8sObjectsApiCoreV1(l, v)
}
