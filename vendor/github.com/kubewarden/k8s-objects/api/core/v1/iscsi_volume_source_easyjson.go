...
func easyjson223df03eDecodeGithubComKubewardenK8sObjectsApiCoreV1(in *jlexer.Lexer, out *ISCSIVolumeSource) {
	...
	for !in.IsDelim('}') {
		...
		case "secretRef":
			if in.IsNull() {
				...
				easyjson223df03eDecodeGithubComKubewardenK8sObjectsApiCoreV11(in, out.SecretRef)
			}
		case "targetPortal":
			if in.IsNull() {
				in.Skip()
...
func easyjson223df03eEncodeGithubComKubewardenK8sObjectsApiCoreV1(out *jwriter.Writer, in ISCSIVolumeSource) {
	out.RawByte('{')
	first := true
	_ = first
	...
	if in.SecretRef != nil {
		...
		out.RawString(prefix)
		easyjson223df03eEncodeGithubComKubewardenK8sObjectsApiCoreV11(out, *in.SecretRef)
	}
	{
...
func (v ISCSIVolumeSource) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson223df03eEncodeGithubComKubewardenK8sObjectsApiCoreV1(&w, v)
...
func (v *ISCSIVolumeSource) UnmarshalJSON(data []byte) error {
	...
	easyjson223df03eDecodeGithubComKubewardenK8sObjectsApiCoreV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *ISCSIVolumeSource) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson223df03eDecodeGithubComKubewardenK8sObjectsApiCoreV1(l, v)
}
func easyjson223df03eDecodeGithubComKubewardenK8sObjectsApiCoreV11(in *jlexer.Lexer, out *LocalObjectReference) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson223df03eEncodeGithubComKubewardenK8sObjectsApiCoreV11(out *jwriter.Writer, in LocalObjectReference) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Name != "" {
