	...
	for !in.IsDelim('}') {
		...
		case "secretRef":
			if in.IsNull() {
				...
				easyjsonB9635d66DecodeGithubComKubewardenK8sObjectsApiCoreV11(in, out.SecretRef)
			}
		case "targetPortal":
			if in.IsNull() {
				in.Skip()
...
func easyjsonB9635d66EncodeGithubComKubewardenK8sObjectsApiCoreV1(out *jwriter.Writer, in ISCSIPersistentVolumeSource) {
	out.RawByte('{')
	first := true
	_ = first
	...
	if in.SecretRef != nil {
		...
		out.RawString(prefix)
		easyjsonB9635d66EncodeGithubComKubewardenK8sObjectsApiCoreV11(out, *in.SecretRef)
	}
	{
...
func (v ISCSIPersistentVolumeSource) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonB9635d66EncodeGithubComKubewardenK8sObjectsApiCoreV1(&w, v)
...
func (v *ISCSIPersistentVolumeSource) UnmarshalJSON(data []byte) error {
	...
	easyjsonB9635d66DecodeGithubComKubewardenK8sObjectsApiCoreV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *ISCSIPersistentVolumeSource) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonB9635d66DecodeGithubComKubewardenK8sObjectsApiCoreV1(l, v)
}
func easyjsonB9635d66DecodeGithubComKubewardenK8sObjectsApiCoreV11(in *jlexer.Lexer, out *SecretReference) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonB9635d66EncodeGithubComKubewardenK8sObjectsApiCoreV11(out *jwriter.Writer, in SecretReference) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Name != "" {
