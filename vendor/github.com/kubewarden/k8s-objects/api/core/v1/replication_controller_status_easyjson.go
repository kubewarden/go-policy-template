...
func easyjson787cf0f8DecodeGithubComKubewardenK8sObjectsApiCoreV1(in *jlexer.Lexer, out *ReplicationControllerStatus) {
...
func easyjson787cf0f8EncodeGithubComKubewardenK8sObjectsApiCoreV1(out *jwriter.Writer, in ReplicationControllerStatus) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v ReplicationControllerStatus) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson787cf0f8EncodeGithubComKubewardenK8sObjectsApiCoreV1(&w, v)
...
func (v *ReplicationControllerStatus) UnmarshalJSON(data []byte) error {
	...
	easyjson787cf0f8DecodeGithubComKubewardenK8sObjectsApiCoreV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *ReplicationControllerStatus) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson787cf0f8DecodeGithubComKubewardenK8sObjectsApiCoreV1(l, v)
}
