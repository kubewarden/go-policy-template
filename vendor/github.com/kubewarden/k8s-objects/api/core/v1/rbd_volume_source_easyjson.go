...
func easyjson345099d5DecodeGithubComKubewardenK8sObjectsApiCoreV1(in *jlexer.Lexer, out *RBDVolumeSource) {
...
func easyjson345099d5EncodeGithubComKubewardenK8sObjectsApiCoreV1(out *jwriter.Writer, in RBDVolumeSource) {
	out.RawByte('{')
	first := true
	_ = first
	if in.FSType != "" {
...
func (v RBDVolumeSource) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson345099d5EncodeGithubComKubewardenK8sObjectsApiCoreV1(&w, v)
...
func (v *RBDVolumeSource) UnmarshalJSON(data []byte) error {
	...
	easyjson345099d5DecodeGithubComKubewardenK8sObjectsApiCoreV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *RBDVolumeSource) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson345099d5DecodeGithubComKubewardenK8sObjectsApiCoreV1(l, v)
}
