...
func easyjson6549b042DecodeGithubComKubewardenK8sObjectsApiCoreV1(in *jlexer.Lexer, out *PortworxVolumeSource) {
...
func easyjson6549b042EncodeGithubComKubewardenK8sObjectsApiCoreV1(out *jwriter.Writer, in PortworxVolumeSource) {
	out.RawByte('{')
	first := true
	_ = first
	if in.FSType != "" {
...
func (v PortworxVolumeSource) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson6549b042EncodeGithubComKubewardenK8sObjectsApiCoreV1(&w, v)
...
func (v *PortworxVolumeSource) UnmarshalJSON(data []byte) error {
	...
	easyjson6549b042DecodeGithubComKubewardenK8sObjectsApiCoreV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PortworxVolumeSource) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson6549b042DecodeGithubComKubewardenK8sObjectsApiCoreV1(l, v)
}
