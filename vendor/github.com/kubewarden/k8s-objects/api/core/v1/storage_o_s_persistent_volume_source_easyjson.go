...
func easyjsonC176eebaDecodeGithubComKubewardenK8sObjectsApiCoreV1(in *jlexer.Lexer, out *StorageOSPersistentVolumeSource) {
...
func easyjsonC176eebaEncodeGithubComKubewardenK8sObjectsApiCoreV1(out *jwriter.Writer, in StorageOSPersistentVolumeSource) {
	out.RawByte('{')
	first := true
	_ = first
	if in.FsType != "" {
...
func (v StorageOSPersistentVolumeSource) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonC176eebaEncodeGithubComKubewardenK8sObjectsApiCoreV1(&w, v)
...
func (v *StorageOSPersistentVolumeSource) UnmarshalJSON(data []byte) error {
	...
	easyjsonC176eebaDecodeGithubComKubewardenK8sObjectsApiCoreV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *StorageOSPersistentVolumeSource) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonC176eebaDecodeGithubComKubewardenK8sObjectsApiCoreV1(l, v)
}
