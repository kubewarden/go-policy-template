...
func easyjsonCe763073DecodeGithubComKubewardenK8sObjectsApiCoreV1(in *jlexer.Lexer, out *RBDPersistentVolumeSource) {
	...
	for !in.IsDelim('}') {
		...
		case "secretRef":
			if in.IsNull() {
				...
				easyjsonCe763073DecodeGithubComKubewardenK8sObjectsApiCoreV11(in, out.SecretRef)
			}
		case "user":
...
func easyjsonCe763073EncodeGithubComKubewardenK8sObjectsApiCoreV1(out *jwriter.Writer, in RBDPersistentVolumeSource) {
	out.RawByte('{')
	first := true
	_ = first
	if in.FSType != "" {
	...
	if in.SecretRef != nil {
		...
		out.RawString(prefix)
		easyjsonCe763073EncodeGithubComKubewardenK8sObjectsApiCoreV11(out, *in.SecretRef)
	}
	if in.User != "" {
...
func (v RBDPersistentVolumeSource) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonCe763073EncodeGithubComKubewardenK8sObjectsApiCoreV1(&w, v)
...
func (v *RBDPersistentVolumeSource) UnmarshalJSON(data []byte) error {
	...
	easyjsonCe763073DecodeGithubComKubewardenK8sObjectsApiCoreV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *RBDPersistentVolumeSource) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonCe763073DecodeGithubComKubewardenK8sObjectsApiCoreV1(l, v)
}
func easyjsonCe763073DecodeGithubComKubewardenK8sObjectsApiCoreV11(in *jlexer.Lexer, out *SecretReference) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonCe763073EncodeGithubComKubewardenK8sObjectsApiCoreV11(out *jwriter.Writer, in SecretReference) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Name != "" {
