...
func easyjsonE799ca47DecodeGithubComKubewardenK8sObjectsApiCoreV1(in *jlexer.Lexer, out *AzureFilePersistentVolumeSource) {
	...
	for !in.IsDelim('}') {
		...
		case "secretNamespace":
			out.SecretNamespace = string(in.String())
		case "shareName":
			if in.IsNull() {
				in.Skip()
				out.ShareName = nil
...
func easyjsonE799ca47EncodeGithubComKubewardenK8sObjectsApiCoreV1(out *jwriter.Writer, in AzureFilePersistentVolumeSource) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ReadOnly {
	...
	if in.SecretNamespace != "" {
		const prefix string = ",\"secretNamespace\":"
		out.RawString(prefix)
		out.String(string(in.SecretNamespace))
	}
	{
...
func (v AzureFilePersistentVolumeSource) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonE799ca47EncodeGithubComKubewardenK8sObjectsApiCoreV1(&w, v)
...
func (v *AzureFilePersistentVolumeSource) UnmarshalJSON(data []byte) error {
	...
	easyjsonE799ca47DecodeGithubComKubewardenK8sObjectsApiCoreV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *AzureFilePersistentVolumeSource) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonE799ca47DecodeGithubComKubewardenK8sObjectsApiCoreV1(l, v)
}
