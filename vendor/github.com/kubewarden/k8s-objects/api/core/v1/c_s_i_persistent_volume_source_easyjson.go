	...
	for !in.IsDelim('}') {
		...
		case "controllerExpandSecretRef":
			if in.IsNull() {
				...
				easyjson92d5e37cDecodeGithubComKubewardenK8sObjectsApiCoreV11(in, out.ControllerExpandSecretRef)
			}
...
func easyjson92d5e37cEncodeGithubComKubewardenK8sObjectsApiCoreV1(out *jwriter.Writer, in CSIPersistentVolumeSource) {
	...
	if in.ControllerExpandSecretRef != nil {
		...
		easyjson92d5e37cEncodeGithubComKubewardenK8sObjectsApiCoreV11(out, *in.ControllerExpandSecretRef)
	}
