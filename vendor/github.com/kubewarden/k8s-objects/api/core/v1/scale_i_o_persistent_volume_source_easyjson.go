...
func easyjson88a248ebDecodeGithubComKubewardenK8sObjectsApiCoreV1(in *jlexer.Lexer, out *ScaleIOPersistentVolumeSource) {
	...
	for !in.IsDelim('}') {
		...
		case "secretRef":
			if in.IsNull() {
				...
				easyjson88a248ebDecodeGithubComKubewardenK8sObjectsApiCoreV11(in, out.SecretRef)
			}
		case "sslEnabled":
...
func easyjson88a248ebEncodeGithubComKubewardenK8sObjectsApiCoreV1(out *jwriter.Writer, in ScaleIOPersistentVolumeSource) {
	out.RawByte('{')
	first := true
	_ = first
	if in.FsType != "" {
	...
	}
	{
		...
		if in.SecretRef == nil {
			...
			easyjson88a248ebEncodeGithubComKubewardenK8sObjectsApiCoreV11(out, *in.SecretRef)
		}
	}
	if in.SslEnabled {
...
func (v ScaleIOPersistentVolumeSource) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson88a248ebEncodeGithubComKubewardenK8sObjectsApiCoreV1(&w, v)
...
func (v *ScaleIOPersistentVolumeSource) UnmarshalJSON(data []byte) error {
	...
	easyjson88a248ebDecodeGithubComKubewardenK8sObjectsApiCoreV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *ScaleIOPersistentVolumeSource) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson88a248ebDecodeGithubComKubewardenK8sObjectsApiCoreV1(l, v)
}
func easyjson88a248ebDecodeGithubComKubewardenK8sObjectsApiCoreV11(in *jlexer.Lexer, out *SecretReference) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson88a248ebEncodeGithubComKubewardenK8sObjectsApiCoreV11(out *jwriter.Writer, in SecretReference) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Name != "" {
