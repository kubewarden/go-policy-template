...
func easyjsonAb95dfaDecodeGithubComKubewardenK8sObjectsApiCoreV1(in *jlexer.Lexer, out *StorageOSVolumeSource) {
...
func easyjsonAb95dfaEncodeGithubComKubewardenK8sObjectsApiCoreV1(out *jwriter.Writer, in StorageOSVolumeSource) {
	out.RawByte('{')
	first := true
	_ = first
	if in.FsType != "" {
...
func (v StorageOSVolumeSource) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonAb95dfaEncodeGithubComKubewardenK8sObjectsApiCoreV1(&w, v)
...
func (v *StorageOSVolumeSource) UnmarshalJSON(data []byte) error {
	...
	easyjsonAb95dfaDecodeGithubComKubewardenK8sObjectsApiCoreV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *StorageOSVolumeSource) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonAb95dfaDecodeGithubComKubewardenK8sObjectsApiCoreV1(l, v)
}
