...
func easyjsonE2bfc1e7DecodeGithubComKubewardenK8sObjectsApiCoreV1(in *jlexer.Lexer, out *StorageOSVolumeSource) {
...
func easyjsonE2bfc1e7EncodeGithubComKubewardenK8sObjectsApiCoreV1(out *jwriter.Writer, in StorageOSVolumeSource) {
	out.RawByte('{')
	first := true
	_ = first
	if in.FSType != "" {
...
func (v StorageOSVolumeSource) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonE2bfc1e7EncodeGithubComKubewardenK8sObjectsApiCoreV1(&w, v)
...
func (v *StorageOSVolumeSource) UnmarshalJSON(data []byte) error {
	...
	easyjsonE2bfc1e7DecodeGithubComKubewardenK8sObjectsApiCoreV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *StorageOSVolumeSource) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonE2bfc1e7DecodeGithubComKubewardenK8sObjectsApiCoreV1(l, v)
}
