...
func easyjson5a4557c5DecodeGithubComKubewardenK8sObjectsApiCoreV1(in *jlexer.Lexer, out *ScopedResourceSelectorRequirement) {
...
func easyjson5a4557c5EncodeGithubComKubewardenK8sObjectsApiCoreV1(out *jwriter.Writer, in ScopedResourceSelectorRequirement) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v ScopedResourceSelectorRequirement) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson5a4557c5EncodeGithubComKubewardenK8sObjectsApiCoreV1(&w, v)
...
func (v *ScopedResourceSelectorRequirement) UnmarshalJSON(data []byte) error {
	...
	easyjson5a4557c5DecodeGithubComKubewardenK8sObjectsApiCoreV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *ScopedResourceSelectorRequirement) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson5a4557c5DecodeGithubComKubewardenK8sObjectsApiCoreV1(l, v)
}
