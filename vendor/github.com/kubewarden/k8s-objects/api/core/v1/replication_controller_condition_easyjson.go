...
func easyjson9a7ce39fDecodeGithubComKubewardenK8sObjectsApiCoreV1(in *jlexer.Lexer, out *ReplicationControllerCondition) {
...
func easyjson9a7ce39fEncodeGithubComKubewardenK8sObjectsApiCoreV1(out *jwriter.Writer, in ReplicationControllerCondition) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v ReplicationControllerCondition) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson9a7ce39fEncodeGithubComKubewardenK8sObjectsApiCoreV1(&w, v)
...
func (v *ReplicationControllerCondition) UnmarshalJSON(data []byte) error {
	...
	easyjson9a7ce39fDecodeGithubComKubewardenK8sObjectsApiCoreV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *ReplicationControllerCondition) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson9a7ce39fDecodeGithubComKubewardenK8sObjectsApiCoreV1(l, v)
}
