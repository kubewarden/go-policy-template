	...
	for !in.IsDelim('}') {
		...
		case "podFailurePolicy":
			if in.IsNull() {
				...
				easyjsonAfab81ddDecodeGithubComKubewardenK8sObjectsApiBatchV11(in, out.PodFailurePolicy)
			}
		case "selector":
			if in.IsNull() {
				in.Skip()
...
func easyjsonAfab81ddEncodeGithubComKubewardenK8sObjectsApiBatchV1(out *jwriter.Writer, in JobSpec) {
	...
	if in.PodFailurePolicy != nil {
		...
		easyjsonAfab81ddEncodeGithubComKubewardenK8sObjectsApiBatchV11(out, *in.PodFailurePolicy)
	}
	if in.Selector != nil {
...
func easyjsonAfab81ddDecodeGithubComKubewardenK8sObjectsApiBatchV11(in *jlexer.Lexer, out *PodFailurePolicy) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjsonAfab81ddDecodeGithubComKubewardenK8sObjectsApiBatchV12(in, v1)
					}
...
func easyjsonAfab81ddEncodeGithubComKubewardenK8sObjectsApiBatchV11(out *jwriter.Writer, in PodFailurePolicy) {
	out.RawByte('{')
	first := true
	_ = first
	{
		...
		if in.Rules == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v2, v3 := range in.Rules {
				...
				if v3 == nil {
					...
					easyjsonAfab81ddEncodeGithubComKubewardenK8sObjectsApiBatchV12(out, *v3)
				}
			}
			out.RawByte(']')
		}
...
func easyjsonAfab81ddDecodeGithubComKubewardenK8sObjectsApiBatchV12(in *jlexer.Lexer, out *PodFailurePolicyRule) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "onExitCodes":
			if in.IsNull() {
				...
				easyjsonAfab81ddDecodeGithubComKubewardenK8sObjectsApiBatchV13(in, out.OnExitCodes)
			}
			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjsonAfab81ddDecodeGithubComKubewardenK8sObjectsApiBatchV14(in, v4)
					}
...
func easyjsonAfab81ddEncodeGithubComKubewardenK8sObjectsApiBatchV12(out *jwriter.Writer, in PodFailurePolicyRule) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	if in.OnExitCodes != nil {
		...
		out.RawString(prefix)
		easyjsonAfab81ddEncodeGithubComKubewardenK8sObjectsApiBatchV13(out, *in.OnExitCodes)
	}
	{
		...
		if in.OnPodConditions == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v5, v6 := range in.OnPodConditions {
				...
				if v6 == nil {
					...
					easyjsonAfab81ddEncodeGithubComKubewardenK8sObjectsApiBatchV14(out, *v6)
				}
			}
			out.RawByte(']')
		}
...
func easyjsonAfab81ddDecodeGithubComKubewardenK8sObjectsApiBatchV14(in *jlexer.Lexer, out *PodFailurePolicyOnPodConditionsPattern) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonAfab81ddEncodeGithubComKubewardenK8sObjectsApiBatchV14(out *jwriter.Writer, in PodFailurePolicyOnPodConditionsPattern) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjsonAfab81ddDecodeGithubComKubewardenK8sObjectsApiBatchV13(in *jlexer.Lexer, out *PodFailurePolicyOnExitCodesRequirement) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonAfab81ddEncodeGithubComKubewardenK8sObjectsApiBatchV13(out *jwriter.Writer, in PodFailurePolicyOnExitCodesRequirement) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ContainerName != "" {
